        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <h4 class="mb-3">Thông tin cá nhân
                    <a href="{{ url('change-password') }}" class="btn btn-outline-danger float-end">Đổi mật khẩu ?</a>
                </h4>
                <div class="underline mb-4 bg-dark"></div>
            </div>
            <div class="col-md-10">
                ...
                <div class="card shadow">
                    <div class="card-header bg-dark">
                        <h4 class="mb-0 text-white">Thông tin cá nhân</h4>
                    </div>
                    <div class="card-body">
