                ...
                <div class="card-body">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="5"><img src="https://isuckhoe.net/wp-content/uploads/2021/06/isuckhoe_bmngqdr.jpg" alt="Còn cái nịt" style="width:200px;height:200px;border-radius:0;margin-left:20px;"></td>
                            </tr>
                            @endforelse
