    ...
    <div class="py-3 py-md-4 checkout">
        <div class="container">
                ...
                <div class="col-md-12 mb-4">
                    <div class="shadow bg-white p-3">
                        <h4 class="text-primary">
                            ...
                            <!-- @php $totalPrice = round($this->totalProductAmount / 24000) @endphp -->
                        </h4>
                        <hr>
                        <small>* Đơn hàng sẽ về sau 3 - 5 ngày.</small>
                        <br />
                    ...
                    <div class="shadow bg-white p-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" wire:model.defer="fullname" id="fullname" class="form-control" placeholder="Vui lòng nhập tên" />
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" wire:model.defer="pincode" id="pincode" class="form-control" placeholder="Nhập Pin-code" />
                            ...
                            <div class="col-md-12 mb-3" wire:ignore>
                                <label>Vui lòng chọn phương thức thanh toán: </label>
                                <div class="d-md-flex align-items-start">
                                    ...
                                    <div class="tab-content col-md-9" id="v-pills-tabContent">
                                        <div class="tab-pane active show fade" id="cashOnDeliveryTab" role="tabpanel" aria-labelledby="cashOnDeliveryTab-tab" tabindex="0">
                                            ...
                                            <hr />
                                            <button type="button" wire:loading.attr="disabled" wire:click="codOrders" class="btn btn-primary">
                                                <span wire:loading.remove wire:target="codOrders">
                                                    Đặt Hàng (Thanh Toán Khi Nhận Hàng)
                                                </span>
                                                <span wire:loading wire:target="codOrders">
                                                    Đang Xử Lý
                                                </span>
                                            </button>
            ...
            <div class="card card-body shadow text-center p-md-5">
                <h4>Không có đơn hàng nào đã đặt</h4>
...
@push('scripts')
    <script src="https://www.paypal.com/sdk/js?client-id=AdVKz5zbNnOFwgxbJlPFEpdaY29Aux9b33haXBTOGpIFHWA-aZVlN5lFnOHQRF8zz31RHKwwIq0RT7Vy&currency=USD"></script>
    <script>
        paypal.Buttons({
            onClick: function()  {
            ...
            createOrder: (data, actions) => {
                return actions.order.create({
                    purchase_units: [{
                        amount: {
                            value: "{{ round($this->totalProductAmount / 24000,1)}}"//"{{ $this->totalProductAmount }}" // Can also reference a variable or function
                        }
                    }]
                });
            },
