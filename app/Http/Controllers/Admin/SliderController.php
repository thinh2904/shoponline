...
use App\Http\Requests\SilderFormRequest;
...
class SliderController extends Controller
{
    ...
    public function store(SilderFormRequest $request)
    {
    ...
    public function update(SilderFormRequest $request, Slider $slider)
    {
        $validatedData = $request->validated();
    ...
    public function destroy(Slider $slider)
    {
        ...
        return redirect('admin/sliders')->with('message','Co gi do sai sai');
